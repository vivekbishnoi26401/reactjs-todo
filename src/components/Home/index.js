...
const [newDescripiton,setNewDescription] = useState("");
            ...
            <div className='todo-wrapper'>
                <div className='todo-input'>
                    ...
                    <div className='todo-input-item'>
                        ...
                        <input type='text' value={newDescripiton} onChange={(e)=>setNewDescription(e.target.value)} placeholder="What's the task description"/>
                    </div>
                    <div className='todo-input-item'>
